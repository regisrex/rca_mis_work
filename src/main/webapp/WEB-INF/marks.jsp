...
<div>
    <div class="text-white bg-teal-700 px-32 py-4 flex items-center justify-between">
        ...
        <div class="text_header text-2xl font-semibold">Marks</div>
    ...
    <div class="px-32">
        <c:if test="${authenticatedUser !=null}">
            <div class="flex items-center justify-between my-4 py-2 border-y border-slate-100"   >
                <a href="createmark.php?page=createmark" class="px-4 py-3 w-fit  flex items-center gap-4 bg-teal-500 text-white ">

                    <img src="icons/user_add.png" /> <span>Add marks</span>
            ...
            <table style="border: 0;">
                ...
                <table class="w-full ">
                    ...
                    <tr class="bg-teal-500 text-white font-bold">
                        ...
                        <td class="px-4 py-2">Marks</td>
                    </tr>
                    </thead>
                    <tbody>
                    <c:forEach items="${marks}" var="mrk" varStatus="mrkstatus">
                        <tr class="bg-teal-100">
                            <td class="px-4 py-2">${mrk.getStudentName()}</td>
                            <td class="px-4 py-2">${mrk.getSubject()}</td>
                            <td class="px-4 py-2">${mrk.getMarksObtained()}</td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
